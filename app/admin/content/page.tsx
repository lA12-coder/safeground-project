...
const initialContent: ContentItem[] = [
  ...
  { id: '3', type: 'article', title: 'Understanding Khat Addiction', body: 'Khat (Catha edulis) is a flowering plant native to the Horn of Africa. Its leaves contain cathinone, a stimulant that can lead to psychological dependence...', language: 'en', tags: ['education', 'science'], is_published: true, created_at: '2026-05-15T09:00:00Z', updated_at: '2026-05-20T14:00:00Z' },
  ...
  { id: '7', type: 'professional_resource', title: 'Counselor Referral Guidelines', body: 'When referring a client to addiction counseling: assess readiness, identify barriers, provide warm handoff, and schedule follow-up within 48 hours.', language: 'en', tags: ['counselor', 'protocol'], is_published: false, created_at: '2026-04-20T15:00:00Z', updated_at: '2026-04-20T15:00:00Z' },
